...
proxy = {
    "http":"http://yudaikadek22:45126034@cache.itb.ac.id:8080",
    "https":"http://yudaikadek22:45126034@cache.itb.ac.id:8080",
}
...
def crawlCarData(car_url):
    try:
        response = requests.get(car_url, proxies=proxy)
...
def crawlWebsite():
    ...
    driver = webdriver.Chrome('/usr/local/bin/chromedriver', seleniumwire_options=options, options=chrome_options)
